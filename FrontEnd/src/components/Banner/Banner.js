      ...
      >
        ...
        <div className="w-full mt-5 lg:pt-10">
          <div className="mx-auto text-center">
            <h1 className="mb-5 text-white mx-auto text-center font-[600px] w-[200px] text-[50px] md:w-[300px] md:text-[100px] lg:text-[120px] lg:w-[500px]">
              Let Story's Shine
            </h1>
        ...
        <div className="text-white text-xl font-semibold text-center pb-[80px] md:py-[120px] lg:py-[200px] lg:text-left lg:pl-24">
